...
result_dir=$RESULTS_PATH/fig6_c_d/pmonly/
...
do
        ...
        do
                ...
                numactl --cpunodebind=0 $MICROBENCH_PATH/hetero_io_bench -r $thread -j $workloadid -s 4096 -t 1 -y 0 -x 0 -z 1g -f 1 -d 1 &> $output/result.txt
