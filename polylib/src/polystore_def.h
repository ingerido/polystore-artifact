...
//#define POLY_CACHE_VADDR_BASE           0x600000000000UL

#define POLY_INODE_VADDR_RANGE          0x1000000000UL
#define POLY_INDEX_VADDR_RANGE          0x1000000000UL
#define POLYSTORE_TASK_CTX_VADDR_RANGE  0x1000000UL
#define POLYSTORE_CONFIG_VAR_SIZE       0x1000UL 
